                    ...
                    <div class="panel panel-primary">
						...
						<form action='' method='post'>
                            <div class="form-group">
                                            ...
                                            <select name="rmid" id='rmid' class="form-control" required/>
												<?php
include('db.php');
$rsql ="select `room_type-id` from `room-type`";
$rre=mysqli_query($con,$rsql);

												while($rrow=mysqli_fetch_array($rre))
												{
												$value = $rrow['room_type-id'];
...
<button class="btn btn-primary" name='btnBooking' id='btnBooking'><span>Delete Room</span></button>
							</form>
							...
							<?php
							 ...
							 if(isset($_POST['btnBooking']))
							 {
								...
								$sql ="DELETE FROM `room` WHERE `room_type-id` = '".$did."'" ;

								$sql1 ="DELETE FROM `room-type` WHERE `room_type-id` = '".$did."'" ;
